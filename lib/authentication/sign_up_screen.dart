                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text('Sign Up', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
                      ),
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text('Welcome to something',
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: (input) => emailValidator(input) ? null : "Please enter a valid email address",
                                      onChanged: (input){
                                        email = input;
                                      },
                                      ...
                                      style: TextStyle(color: Colors.black.withOpacity(0.7), fontWeight: FontWeight.w500, fontSize: 15),
                                    ),
                                  ),
                                  SizedBox(height: 10),
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Text('Already have an account? ',
                                          style: TextStyle(color: Colors.grey.withOpacity(0.7), fontSize: 15, fontWeight: FontWeight.w300)),
                                        Material(
                                          color: Colors.white,
                                          child: Text('Sign In',
